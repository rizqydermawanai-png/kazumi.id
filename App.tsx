...
import { type AppContextType, type CartItem, type User, type SiteConfig, type ShippingPackage, Category, Order, Product, Courier, ProductDiscount, PromoCode, AppNotification, Toast, BankAccount, QrisInfo, CustomOrderRequest, WarrantyClaim, Bundle, SizeChart } from './types';
...
// FIX: Added mockOrders, courierOptions, and mockCustomOrderRequests to the import from constants.tsx after exporting them.
import { mockOrders, courierOptions, mockCustomOrderRequests, products as initialProducts, initialSizeCharts } from './constants';
...
const initialBankAccounts: BankAccount[] = [
    { id: 'bank001', name: 'BCA', accNumber: '1234567890', accName: 'PT KAZUMI INDONESIA', logo: '/logos/bca.png', virtualAccountNumber: '88081234567890' },
    { id: 'bank002', name: 'Mandiri', accNumber: '0987654321', accName: 'PT KAZUMI INDONESIA', logo: '/logos/mandiri.png', virtualAccountNumber: '99081234567890' },
];
...
const App: React.FC = () => {
  ...
  const [sizeCharts, setSizeCharts] = useState<SizeChart[]>(initialSizeCharts);
