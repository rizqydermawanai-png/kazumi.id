// components/pages/Recapitulation.tsx
...
export const RecapitulationPage = ({ sales, productionReports, materials, finishedGoods, activityLogs, users }: RecapitulationPageProps) => {
    ...
    const totalMaterialStock = materials.reduce((sum, mat) => sum + mat.stock, 0);
    ...
    return (
        <div className="space-y-6">
            ...
            >
                ...
                <StatCard title="Total Stok Material" value={`${totalMaterialStock} unit`} icon={<Archive size={24} className="text-white"/>} color="bg-orange-500" />
            </motion.div>
