...
const SizeGuideDrawer: React.FC<SizeGuideDrawerProps> = ({ isOpen, onClose, chart }) => {
    ...
    return (
        <>
            ...
            <div className={`size-guide-drawer ${isOpen ? 'open' : ''}`}>
...
const ProductDetailPage: React.FC = () => {
    ...
    return (
        <main className="page-container">
            <div className="product-detail-layout">
                ...
                <div className="product-detail-gallery">
                    <div className="product-detail-image-main" onClick={openImageModal}>
                        <img src={product.imageUrls[currentImageIndex]} alt={`${product.name} view ${currentImageIndex + 1}`} />
                    </div>
            ...
            {isModalOpen && (
                <div id="imageModal" className="image-zoom-modal" onClick={() => setIsModalOpen(false)}>
