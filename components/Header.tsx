...
const SearchModal: React.FC<SearchModalProps> = ({ isOpen, onClose }) => {
    ...
    return (
        <div className="search-modal-overlay active" onClick={onClose}>
        ...
        <>
            <header className={`header ${scrolled ? 'scrolled' : ''}`}>
                <nav className="nav-container">
                    ...
                    <Link to="/" className="logo">KAZUMI</Link>
                    ...
                    <div className="nav-actions">
                        <button onClick={() => setIsSearchOpen(true)} title="Search">
                        ...
                        <Link to="/tracking" title="Lacak Pesanan">
                        ...
                        {context?.user ? (
                             <>
                                ...
                                >
                                    <button title="Notifikasi" className="relative">
                                ...
                                >
                                    <a href="#" onClick={(e) => e.preventDefault()} className="dropbtn" title="Akun Saya">
                        ...
                        {context?.user?.role === 'superadmin' && (
                             <Link to="/admin/dashboard" title="Super Admin Dashboard" className="admin-dashboard-link">
