...
// ++ NEW: Detailed Size Chart Types ++
export interface SizeMeasurement {
    length?: [number, number];
    chestWidth?: [number, number];
...
export interface SizeChart {
    ...
    name: string;
    category: Category;
    style?: string; // Corresponds to product sub-category/style
    details: SizeDetail[];
}
// -- END NEW TYPES --
...
export interface Product {
  ...
  sizeChartId?: string; // New: Link to a size chart
}
...
export interface AppContextType {
  ...
  updateSizeCharts: React.Dispatch<React.SetStateAction<SizeChart[]>>;
}
