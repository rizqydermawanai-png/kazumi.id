...
const icons = {
    ...
    error: <AlertCircleIcon className="text-red-500" size={24} />,
...
export const ToastContainer = ({ toasts }: { toasts: ToastProps[] }) => {
    return (
        <div id="toast-container" className="fixed inset-0 z-[9999] flex items-end px-4 py-6 pointer-events-none sm:p-6 sm:items-start">
